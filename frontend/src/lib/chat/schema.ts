...
export const IESO_TABLES: TableSchema[] = [
  {
    ...
    frequency: '5-minute',
    columns: [
      { name: 'timestamp', type: 'DateTime', description: 'UTC timestamp of the price interval' },
  ...
  },
  {
    ...
    frequency: '5-minute',
    columns: [
      { name: 'timestamp', type: 'DateTime', description: 'UTC timestamp of the demand reading' },
  ...
  },
  {
    ...
    frequency: '5-minute',
    columns: [
      { name: 'timestamp', type: 'DateTime', description: 'UTC timestamp of the reading' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'publish_timestamp', type: 'DateTime', description: 'UTC timestamp of the latest forecast publish for this delivery slot' },
    ],
  },
  {
    name: 'v_da_ozp',
    ...
    columns: [
      ...
      { name: 'publish_timestamp', type: 'DateTime', description: 'UTC timestamp of the latest DA price publish for this delivery slot' },
    ],
  },
  {
    name: 'v_weather',
    description: 'Deduplicated weather observations from Open-Meteo for Ontario zones',
    frequency: '15-minute',
    columns: [
      { name: 'timestamp', type: 'DateTime', description: 'UTC timestamp of the weather observation' },
